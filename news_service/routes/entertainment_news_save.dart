...
Future<Response> onRequest(RequestContext context) async {
  ...
  try {
    final rssUrl =
        'https://news.google.com/rss/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNREpxYW5RU0FtdHZHZ0pMVWlnQVAB?hl=ko&gl=KR&ceid=KR%3Ako';
    ...
    for (var item in items) {
      ...
      newsByDate[dateStr]!.putIfAbsent('엔터테인먼트', () => []);

      if (!newsByDate[dateStr]!['엔터테인먼트']!
          .any((n) => n['title'] == newsObj['title'])) {
        newsByDate[dateStr]!['엔터테인먼트']!.add(newsObj);
      }
    }
